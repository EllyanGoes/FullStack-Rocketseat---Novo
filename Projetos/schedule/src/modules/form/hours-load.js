//Carregamento/renderização das horas disponíveis
...
export function hoursLoad({ date, dailySchedules }) {
  ...
  const opening = openingHours.map((hour) => {
    ...
    //Só vai ser considerado um horário disponível, se não for um horário que já está agendado e não está no passado
